...
{{--                        <li class="active"><a href="{{ route('fronts.create') }}">Home</a></li>--}}
{{--                        <li><a href="{{ route('fronts.course') }}">Courses</a></li>--}}
...
{{--                                                    <figure class="probootstrap-media"><img src="{{ asset('images/exam.jpg') }}" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></figure>--}}
{{--                                                    <div class="probootstrap-text">--}}
{{--                                                        <h3>🗣🗣🗣🗣🗣🗣🗣🗣🗣🗣🗣🗣🗣🗣</h3>--}}
{{--                                                        <p>Finally, we are going to announce the results of our Grammar Monitoring Test. 🤩🤩🤩</p>--}}
{{--                                                        <span class="probootstrap-date"><i class="icon-calendar"></i>July 12, 2022</span>--}}
